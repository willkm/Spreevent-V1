<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarEvento.aspx.cs" Inherits="Spreevent_V1.EditarEvento" %>
			...
			<div class="demo-layout mdl-layout mdl-js-layout mdl-layout-drawer mdl-layout--fixed-header">
				...
				<div class="demo-drawer mdl-layout__drawer mdl-color--blue-900 mdl-color-text--blue-grey-50">
					...
					<header class="demo-drawer-header mdl-layout-drawer">
						<a href="SeuPerfil.aspx">
							<img src="Source/img/user.jpg" class="demo-avatar" /></a>
						<label for="nome-user" class="mdl-layout-title-nome">Maria Fulana</label>
					</header>
									...
									<div class="mdl-grid">
										...
										<div class="mdl-cell mdl-cell--4-col mdl-cell--6-col-tablet mdl-cell--8-col-phone fundo-grid">
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												...
												<asp:TextBox ID="txtNome" runat="server" CssClass="text-input"></asp:TextBox>
											</div>

											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<label for="txtLocal">Local do evento :</label>
												<asp:TextBox ID="txtLocal" runat="server" CssClass="text-input"></asp:TextBox>
											</div>

											<!-- DATA E HORA DO EVENTO -->

											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<label for="txtDataIni">Data de inicio do evento :</label>
												<asp:Label ID="erroData" runat="server" Text="Label"></asp:Label>
												<asp:TextBox runat="server" ID="txtDataIni"></asp:TextBox>
											</div>

											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<label for="txtHoraIni">Hora de inicio do evento :</label>
												<asp:Label ID="erroHoraini" runat="server" Text="Label"></asp:Label>
												<asp:TextBox runat="server" ID="txtHoraIni" TextMode="Time"></asp:TextBox>
											</div>

											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<label for="txtDataFim">Data de término do evento :</label>
												<asp:Label ID="erroDataFim" runat="server" Text="Label"></asp:Label>
												<asp:TextBox runat="server" ID="txtDataFim"></asp:TextBox>
											</div>

											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<label for="txtHoraFim">Hora de término do evento :</label>
												<asp:Label ID="erroHoraFim" runat="server" Text="Label"></asp:Label>
										...
										<div class="mdl-cell mdl-cell--4-col mdl-cell--6-col-tablet mdl-cell--8-col-phone fundo-grid">
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<label for="txtDescricao">Decrição do evento :</label>
												<asp:TextBox ID="txtDescricao" runat="server" CssClass="text-input" TextMode="MultiLine" Columns="4" Height="150"></asp:TextBox>
											</div>

											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<label for="lblddlCategoria">Categoria do evento :</label>
												<div>
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<label for="lblddlTipo">Tipo do evento :</label>
												<div>
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<label for="lblddlIdade">Classificação do evento :</label>
												<div>
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<label for="fuimg"></label>
												<div>
													<asp:FileUpload ID="fuimg" runat="server" /><asp:Label ID="erroImg" runat="server" Text="Label"></asp:Label>
												</div>
											</div>
											...
											<asp:ListView runat="server" ID="list">
												<ItemTemplate>
														...
														<div class="evt-img-bor">
															<!--Card image-->
															<img class="img-fluid" src="<%# Eval("Caminho")%>" width="600" height="400" />
															<!--/.Card image-->
														</div>
										...
										<div class="mdl-cell mdl-cell--4-col mdl-cell--6-col-tablet mdl-cell--8-col-phone fundo-grid">
											<asp:Button runat="server" ID="btnEditar" Text="Editar Evento" OnClick="btnEditar_Click" CssClass="mdl-button mdl-js-button mdl-button--raised mdl-button--accent"/>
											<asp:Button runat="server" ID="btnCancelar" Text="Cancelar" OnClick="btnCancelar_Click" CssClass="mdl-button mdl-js-button mdl-button--raised mdl-button--accent"/>
										</div>
									</div>
								</div>
							</div>
